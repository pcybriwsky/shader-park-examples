...
vec2 cx_log(vec2 a) {
    ...
    // Use step function instead of if statement
    ipart = ipart - step(PI, ipart) * 2.0 * PI;
...
void main() {
    ...
    gl_FragColor = vec4(pal(col, vec3(.52,.45,.61),vec3(.40,.42,.31),vec3(.26,.30,.35),vec3(.15,.4,.4)),1.0);
} 